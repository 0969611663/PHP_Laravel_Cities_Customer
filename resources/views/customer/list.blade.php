...
@section('content')
    <div class="col-12">
        <div class="row">
            ...
            {{--saerch--}}
            <div class="col-6">
                <form class="navbar-form navbar-left" action="{{ route('customer_search') }}">
                    @csrf
                    <div class="row">
                        <div class="col-8">
            ...
            @else
                @foreach($customers as $key => $customer)
                    <tr>
                        ...
                        <td><a href="{{ route('customer_edit', $customer->id) }}">sửa</a></td>
                        <td><a href="{{ route('customer_destroy', $customer->id) }}" class="text-danger"
        ...
        <h5>
            <a class="btn btn-primary" href="{{ route('customer_create') }}">Thêm mới</a>
        </h5>
        <hr>{{ $customers->appends(request()->all())->links() }}
    </div>
